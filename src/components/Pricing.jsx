    ...
    <div name="pricing" className="w-full text-white my-24">
      ...
      <div className="max-w-[1240px] mx-auto py-12">
        <div className="text-center py-8 text-slate-300">
          <h2 className="text-3xl md:text-4xl uppercase">Pricing</h2>
        ...
        <div className="grid md:grid-cols-2">
          <div className="bg-white text-slate-900 m-4 p-4 md:p-8 rounded-xl shadow-2xl relative">
            ...
            <p className="text-xl md:text-2xl py-8 text-slate-500">
